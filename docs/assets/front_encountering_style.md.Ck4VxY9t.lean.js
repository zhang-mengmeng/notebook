...
</code></pre><h3 id="兄弟选择器" tabindex="-1">兄弟选择器 <a class="header-anchor" href="#兄弟选择器" aria-label="Permalink to &quot;兄弟选择器&quot;">​</a></h3><ul><li>相邻兄弟选择器 <ol><li>使用符号 + 连接</li></ol></li><li>普遍兄弟选择器 <ol><li>使用符号 ~ 连接</li></ol></li></ul><h3 id="选择器组" tabindex="-1">选择器组 <a class="header-anchor" href="#选择器组" aria-label="Permalink to &quot;选择器组&quot;">​</a></h3><ul><li>交集选择器 <ol><li>需要同时符合两个选择器条件(两个选择器紧密连接)</li></ol></li><li>并集选择器 <ol><li>符合一个选择器条件即可(两个选择器以，分割)</li></ol></li></ul><h3 id="动态伪类" tabindex="-1">动态伪类 <a class="header-anchor" href="#动态伪类" aria-label="Permalink to &quot;动态伪类&quot;">​</a></h3><ul><li>a:link 未访问的连接</li><li>a:visited 已访问的链接</li><li>a:hover 鼠标挪动到连接上</li><li>a:active 激活的连接</li></ul>`,22)]))}const S=e(r,[["render",o]]);export{u as __pageData,S as default};
